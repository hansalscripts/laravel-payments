...
class FawryPayment extends BaseController implements PaymentInterface 
{
    ...
    {
        $this->fawry_url = config('laravel-payments.FAWRY_URL');
        $this->fawry_merchant = config('laravel-payments.FAWRY_MERCHANT');
        $this->fawry_secret = config('laravel-payments.FAWRY_SECRET');
        $this->fawry_display_mode = config('laravel-payments.FAWRY_DISPLAY_MODE');
        $this->fawry_pay_mode = config('laravel-payments.FAWRY_PAY_MODE');
    ...
    {
        return view('laravel-payments::html.fawry', ['model' => $this, 'data' => $data])->render();
    }
