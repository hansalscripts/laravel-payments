...
class ClickPayPayment extends BaseController implements PaymentInterface
{
    ...
    {
        $this->clickpay_server_key = config('laravel-payments.CLICKPAY_SERVER_KEY');
        $this->clickpay_profile_id = config('laravel-payments.CLICKPAY_PROFILE_ID');
    ...
    public function pay($amount = null, $user_id = null, $user_first_name = null, $user_last_name = null, $user_email = null, $user_phone = null, $source = null): array
    {
        ...
        if (isset($response['tran_ref'])) {
            cache(['clickpay_ref_code_' . $unique_id => $response['tran_ref']]);
            return [
