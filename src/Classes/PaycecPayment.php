...
class PaycecPayment extends BaseController implements PaymentInterface 
{
    ...
    {
        $this->paycec_merchant_username = config('laravel-payments.PAYCEC_MERCHANT_USERNAME');
        $this->paycec_merchant_secret = config('laravel-payments.PAYCEC_MERCHANT_SECRET');
        $this->paycec_mode = config('laravel-payments.PAYCEC_MODE');
