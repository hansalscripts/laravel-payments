...
class PayeerPayment extends BaseController implements PaymentInterface 
{
    ...
    {
        $this->payeer_api_key = config('laravel-payments.PAYEER_API_KEY');
        $this->payeer_additional_api_key = config('laravel-payments.PAYEER_ADDITIONAL_API_KEY');
        $this->payeer_merchant_id = config('laravel-payments.PAYEER_MERCHANT_ID');
