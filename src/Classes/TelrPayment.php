...
class TelrPayment extends BaseController implements PaymentInterface 
{
    ...
    {
        $this->telr_merchant_id = config('laravel-payments.TELR_MERCHANT_ID');
        $this->telr_api_key = config('laravel-payments.TELR_API_KEY');
        $this->telr_mode= config('laravel-payments.TELR_MODE');
