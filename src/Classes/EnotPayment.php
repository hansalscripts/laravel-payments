...
class EnotPayment extends BaseController implements PaymentInterface
{
    ...
    {
        $this->enot_key = config('laravel-payments.ENOT_KEY');
        $this->enot_secret = config('laravel-payments.ENOT_SECRET');
        $this->enot_shop_id = config('laravel-payments.ENOT_SHOP_ID');
