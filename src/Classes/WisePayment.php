...
class WisePayment extends BaseController implements PaymentInterface
{
    ...
    {
        $this->wise_api_key = config('laravel-payments.WISE_API_KEY');
        $this->wise_balance_id = config('laravel-payments.WISE_BALANCE_ID');
        $this->wise_profile_id = config('laravel-payments.WISE_PROFILE_ID');
