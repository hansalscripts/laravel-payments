...
class PrimePayment extends BaseController implements PaymentInterface 
{
    ...
    {
        $this->prime_project_id = config('laravel-payments.PRIME_PROJECT_ID');
        $this->prime_secret_word_1 = config('laravel-payments.PRIME_SECRET_WORD_1');
        $this->prime_secret_word_2 = config('laravel-payments.PRIME_SECRET_WORD_2');
    ...
    public function generate_html($data){
        return str_replace("\n",'',view('laravel-payments::html.bigpay', ['data' => $data])->render());
    }
}