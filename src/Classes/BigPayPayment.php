...
class BigPayPayment extends BaseController implements PaymentInterface 
{
    ...
    {
        $this->bigpay_key = config('laravel-payments.BIGPAY_KEY');
        $this->bigpay_secret = config('laravel-payments.BIGPAY_SECRET');
        $this->bigpay_mode = config('laravel-payments.BIGPAY_MODE');
