...
{ 
    ...
    {
        $this->coinpayments_public_key = config('laravel-payments.COINPAYMENTS_PUBLIC_KEY');
        $this->coinpayments_private_key = config('laravel-payments.COINPAYMENTS_PRIVATE_KEY');
